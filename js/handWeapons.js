var HAND_WEAPONS = [
    ...
    {name: 'Great Sword',         damage: 'Str+d10',   ap: 0,  reach: 0, parry: '-1', twoHanded: true,  cost: 12},
    {name: 'Axe',                 damage: 'Str+d6',    ap: 0,  reach: 0, parry: '',   twoHanded: false, cost: 6},
    {name: 'Battle Axe',          damage: 'Str+d8',    ap: 0,  reach: 0, parry: '',   twoHanded: false,  cost: 9},
    ...
    {name: 'Flail',               damage: 'Str+d6',    ap: 0,  reach: 0, parry: '',   twoHanded: false,  cost: 9,  notes: 'Ignores Shield Parry bonus'},
    {name: 'Maul',                damage: 'Str+d8',    ap: 2,  reach: 0, parry: '-1', twoHanded: true,  cost: 7},
